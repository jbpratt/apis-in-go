...
// inference strings for expected key values
...
func GetStation(c *gin.Context) {
	...
	// c.Param to get path params
	id := c.Param("station_id")
	// query to fetch record by ID, casting TIME field to string
...
func CreateStation(c *gin.Context) {
	var station StationResource
	// parse body into resource | loads data into struct from request
...
// RemoveStation removes resource
