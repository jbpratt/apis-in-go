...
// TrainResource is the model for holding rail info
...
// ScheduleResource links trains and stations
...
func (t *TrainResource) Register(container *restful.Container) {
	...
	// can specify per route as well
	// only accept json, returns 415 automatically for everything else
